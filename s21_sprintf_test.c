...
START_TEST(test_sprintf15) {
  ...
  ck_assert_int_eq(s21_sprintf(str3, format2, 222),
                   sprintf(str4, format2, 222));
  ...
  ck_assert_int_eq(s21_sprintf(str5, format3, 33333333333),
                   sprintf(str6, format3, 33333333333));
...
START_TEST(test_sprintf26) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, "%s", format),
                   sprintf(str2, "%s", format));
